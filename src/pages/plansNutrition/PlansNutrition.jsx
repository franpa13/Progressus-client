...
import { CustomInput, Location, Title, NutritionTable, Button, ModalAddPlan } from "../../components"
...
export const PlansNutrition = () => {
  ...
  return (
    <MainLayout> <section className="animate-fade-in-down md:mx-auto bg-white  rounded shadow-xl w-full md:w-11/12 overflow-hidden mb-20">
      ...
      <NutritionTable loading={loading} arregloColumns={arregloCol} arreglo={plans}></NutritionTable>
    </section>
      <ModalAddPlan open={addPlan} setOpen={setAddPlan}></ModalAddPlan></MainLayout>
  )
}
